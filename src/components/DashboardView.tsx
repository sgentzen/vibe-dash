    ...
    <div style={{ flex: 1, padding: "var(--space-4)", overflowY: "auto" }}>
      ...
      <div style={{
        ...
        <KpiCard
          ...
          tooltip="Milestones with status 'open' in the selected project scope."
        />
        <KpiCard
          label="Overdue Tasks"
          ...
          sparkline={isCompact ? undefined : activityLast7}
          tooltip="Tasks with a due date in the past that are not yet done."
        />
        <KpiCard
          ...
          sparkline={isCompact ? undefined : activityLast7}
          tooltip="Blockers reported via log_blocker that have not been resolved."
        />
        <KpiCard
          label="Active Tasks"
          ...
          sparkline={isCompact ? undefined : activityLast7}
          tooltip="Tasks in any non-done status (planned, in_progress, blocked)."
        />
      </div>
