...
export interface WsEvent {
  type: WsEventType;
  payload: Project | Task | Agent | ActivityEntry | Blocker | Milestone | Tag | TaskTag | AgentSession | TaskDependency | TaskComment | AgentFileLock | FileConflict | AppNotification | MilestoneDailyStats | CostEntry | CompletionMetrics;
}
